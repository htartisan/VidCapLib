# Building VidCapLib Capture Library
...
When linking against the static library, make sure to define `VIDCAPLIB_STATIC` in your project to ensure correct symbol linkage:

```cpp
#define VIDCAPLIB_STATIC
#include "VidCapLib.h"
```
...
```cmake
target_compile_definitions(your_target PRIVATE VIDCAPLIB_STATIC)
```
